...
document.write(" "+week[d]+" "+day+" "+months[month-1]+" "+ year);
  ...
  <form  method="post" name="form1" action="include/insert-mem.asp">
    <table width="400" border="0">
	
      <tr>
        <td width="50%">
          <%if Er=1 then%>نام کاربری یا رمز عبور اشتباه است<%end if%>
       </td>
        <td width="50%"></td>
      </tr>
	  <tr>
        ...
        <td width="50%"><label>نام کاربری</label></td>
      </tr>
      <tr>
       <td>
      ...
      <tr>
        <td>
          <input name="name" type="text" size="40" dir="rtl">
       </td>
        <td><label>نام</label></td>
      </tr>
      <tr>
        <td>
          <input name="family" type="text" size="40" dir="rtl">
       </td>
        <td>نام خانوادگی</td>
      </tr>
      <tr>
        <td>
          <input name="bday" type="text" size="40">
       </td>
        <td><label>تاریخ تولد</label></td>
      </tr>
      <tr>
        <td>
          <input name="no" type="text" size="40">
      </td>
        <td><label>شماره موبایل</label></td>
      </tr>
      <tr>
        <td colspan="2">
