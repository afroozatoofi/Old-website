...
document.write(" "+week[d]+" "+day+" "+months[month-1]+" "+ year);
  ...
  <table width="750" border="0" dir="rtl" cellspacing="0" align="center">
  <%
  
SQLQuery = "Select * From cl_news where n_expert=4"
Set RS=dbaseConn.Execute(SQLQuery)

Do While Not RS.EOF
  %>
    <tr bgcolor="#CCCCCC">
      <td style="color:#339900; font-size:16px; "><%=RS("n_title")%></td>
    </tr>
	<tr bgcolor="#CCCCCC">
      <td><%=RS("n_summery")%></td>
    </tr>
	...
	<tr bgcolor="#CCCCCC">
       <td align="left" style="font-size:14px; ">[<a href="view-allnews.asp?id=<%=RS("n_id")%>" target="www">ادامه مطلب</a>]</td>
    </tr>
