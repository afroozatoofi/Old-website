...
document.write(" "+week[d]+" "+day+" "+months[month-1]+" "+ year);
            ...
            <td>
					...
					<script src="JS/map-2.js" type="text/javascript"></script>
                    <div id="map_canvas" style="width:778px; height:250px; "></div>      
            </td>
            <td width="100"></td>
        </tr>
...
<!-- about clinic -->
            ...
            <table align="center" width="778"><tr height="100px"><td colspan="2" valign="top">
			<table width="770" border="0" dir="rtl">
  <%
